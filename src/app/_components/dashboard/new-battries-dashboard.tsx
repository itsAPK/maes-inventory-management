...
import { TopPurchases } from './top-purchases';
import { TopSales } from './top-sales';
import { TopSellingProducts } from './top-selling-products';

export function NewBatteriesDashboard() {
              ...
              <div className="col-span-12 pt-3">
                <Tabs defaultValue="sales" className="w-full rounded-none">
                  ...
                  <TabsContent value="products">
                    <TopSellingProducts data={sales.data.topProducts.reverse()} dateRage={date} />{' '}
                  </TabsContent>
                </Tabs>
              </div>
            </div>
