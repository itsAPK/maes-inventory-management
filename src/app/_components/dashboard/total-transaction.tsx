...
import { Transaction, DailyData } from '../../../types/index';
...
export function TotalTransAction({
  ...
  total: { sales: number; purchases: number };
}) {
  ...
  return (
    <Card className="rounded shadow-none">
          ...
          {['sales', 'purchases'].map((key) => {
            ...
            return (
              ...
              >
                ...
                <span className="flex font-bold leading-none sm:text-xl">
      ...
      <CardContent className="px-2 sm:p-6">
        <ChartContainer config={chartConfig} className="h-[250px] w-full overflow-auto">
          <BarChart
            accessibilityLayer
            data={transactions}
            margin={{
